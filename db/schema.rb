...
ActiveRecord::Schema.define(version: 2021_08_04_132105) do
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "tag_task_id", null: false
    t.index ["tag_task_id"], name: "index_tags_on_tag_task_id"
  ...
  add_foreign_key "tags", "tag_tasks"
